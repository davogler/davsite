function django_admin_links_div() {
    ...
    var admin_url = '/admin/';
    var div_title = 'DAV Admin';
    var div_style = 'float: right; position: fixed; top: 0; right: 0; border: solid 1px #417690; padding: 3px 5px 3px 5px; text-align: center; color: #fff; background: rgba(255,255,255,0.5); font-size: 11px; z-index:999;';
